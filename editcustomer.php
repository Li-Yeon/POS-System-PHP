                ...
                ?>
                         <form method="POST">
                                     <div class="form-group">
                                         <p>Customer<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="customer_Name" placeholder = "Enter Customer Name" value ="<?php echo $rows['Cust_Name'];?>" required>
                                         <p>Address<p>
                                         <textarea class="form-control" rows="3" name = "customer_Address" placeholder = "Enter Customer Address"><?php echo $rows['Cust_Address'];?></textarea>                    
                                         <p>Tel<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="customer_Tel" placeholder = "Enter Customer Tel" value ="<?php echo $rows['Cust_Tel'];?>">               
                                         <p>Email<p>
                                         <input type="email" class="form-control" style="border-radius: 10px;" name="customer_Email" placeholder = "Enter Customer Email" value ="<?php echo $rows['Cust_Email'];?>">           
                                     </div>
                                     <hr>
                                     <button type="submit" class="btn waves-effect waves-light btn-outline-success" name="editCustomer">Update Customer</button>
