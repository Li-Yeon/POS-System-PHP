    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <a href="./PHP/dropstockexcel.php"><button type="button" class="btn waves-effect waves-light btn-outline-success" style="margin-top:1%"><i class="far fa-file-excel" style="margin-right: 3px"></i>Print to Excel</button></a>
