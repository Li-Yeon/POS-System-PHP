    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Suppliers
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <a href="addsupplier.php"><button type="button" class="btn waves-effect waves-light btn-outline-success" style="margin-top:1%">+ Add Supplier</button></a>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                        while($rows=mysqli_fetch_assoc($suppTable))
                                    {
                                        ?>
                                        <tr>
                                        ...
                                        <td><?php echo $rows['Supplier_Tel'];?></td>
                                        <td><?php echo $rows['Supplier_Email'];?></td>         
                                        <td><?php echo $rows['Supplier_Address'];?></td>
                                            <td class ="tableAction">
                                        <a href="editsupplier.php?edit=<?php echo $rows['No'];?>"><button type="button" class="btn btn-outline-success"><i class="far fa-edit iconEdit"></i></button></a>
                                        <a href="suppliers.php?delete=<?php echo $rows['No'];?>" onclick="return confirm('Confirm delete supplier?');"><button type="button" class="btn btn-outline-danger"><i class="far fa-trash-alt"></i></button></a>
                                            </td>
                            </tr>
                            <?php
                        }
