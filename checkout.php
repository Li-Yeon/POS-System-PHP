<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/php_posv3/PHP/checkout.php';
...
<body>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="settings.php"><i data-feather="settings"
        ...
        unset($_SESSION['status']);
            ...
            <div class="container-fluid">             
                    ...
                    <div class="card-body">
                         ...
                         <form method="POST">
                                     <div class="form-group">
                                         ...
                                         <p>Product<p>
                                         <select class="selectpicker form-control" name = "product_ID" id = "product_ID" style="border-radius: 10px;" data-live-search="true" title="Enter Product ID/Barcode" autofocus>
                                         <?php while($row = mysqli_fetch_array($productRes)):;?>
                                         <option value="<?php echo $row[1];?>"> <?php echo $row[1];?> | <?php echo $row[2];?> | <?php echo $row[6];?></option>
                                         <?php endwhile;?>
                                         </select>     
                                         ...
                                         <input type="number" class="form-control" name="price" id ="pdPrice" readonly>                        
                                         </div>
                                        
                                         <p>Available Stock<p>
                                         <input type="number" class="form-control" id = "pdStock" style="border-radius: 10px;" name="stock" readonly>  

                                         <p>Outgoing Stock<p>
                                         <input type="number" class="form-control" id = "outgoingstock" style="border-radius: 10px;" name="outgoingstock">
                                         
                                         <p>Discount<p>
                                         <input type="number" class="form-control" id = "discount" style="border-radius: 10px;" name="discount">

                                         <p>Remaining Stock<p>
                                         <input type="number" class="form-control" id = "totalStock" style="border-radius: 10px;" name="totalstock" readonly>
                ...
                <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                        while($rows=mysqli_fetch_assoc($checkoutTable))
                                    {
                                        ?>
                                        <tr>
                                        ...
                                        <a href="checkout.php?delete=<?php echo $rows['No'];?>" onclick="return confirm('Confirm undo item?');"><button type="button" class="btn btn-outline-danger"><i class="far fa-trash-alt"></i></button></a>
                                            </td>
                            </tr>
                            <?php
                        }
    ...
    <!-- Bootstrap Select -->
    <link href="Bootstrap/bootstrap-select-1.13.14/dist/css/bootstrap-select.min.css" rel="stylesheet">
...
<script>
 $(document).ready(function(){
   ...
   $("#outgoingstock").on("input", function(){
        currentStock = $("#pdStock").val();
        outgoingStock = $("#outgoingstock").val();
        getCurrentPrice = $("#pdPrice").val();
        getDiscount = $("#discount").val();

        newStock = currentStock - outgoingStock;  
        newPrice = getCurrentPrice * outgoingStock;
        newPrice = newPrice - getDiscount;
