    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <a href="addcustomer.php"><button type="button" class="btn waves-effect waves-light btn-outline-success" style="margin-top:1%">+ Add Customer</button></a>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                        while($rows=mysqli_fetch_assoc($custTable))
                                    {
                                        ?>
                                        <tr>
                                        ...
                                        <a href="editcustomer.php?edit=<?php echo $rows['No'];?>"><button type="button" class="btn btn-outline-success"><i class="far fa-edit iconEdit"></i></button></a>
                                        <a href="customers.php?delete=<?php echo $rows['No'];?>" onclick="return confirm('Confirm delete customer?');"><button type="button" class="btn btn-outline-danger"><i class="far fa-trash-alt"></i></button></a>
                                            </td>
                            </tr>
                            <?php
                        }
