                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Add Supplier
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="card-body">
                         ...
                         <form method="POST">
                                     <div class="form-group">
                                         <p>Supplier ID<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_ID" placeholder = "Enter Supplier ID" required>
                                         <p>Supplier Name<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_Name" placeholder = "Enter Supplier Name" required>
                                         <p>Supplier Tel<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_Tel" placeholder = "Enter Supplier Tel">
                                         <p>Supplier Email<p>
                                         <input type="email" class="form-control" style="border-radius: 10px;" name="supplier_Email" placeholder = "Enter Supplier Email">
                                     ...
                                     <hr>
                                     <button type="submit" class="btn waves-effect waves-light btn-outline-success" name="addSupplier">Add Supplier</button>
