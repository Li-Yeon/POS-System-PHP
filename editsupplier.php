<?php
session_start();
require_once $_SERVER['DOCUMENT_ROOT'].'/php_posv3/PHP/supplier.php';
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Edit Supplier
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                ?>
                         <form method="POST">
                                     <div class="form-group">
                                         <p>Supplier ID<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_ID" placeholder = "Enter Supplier ID" value ="<?php echo $rows['Supplier_ID'];?>" readonly required>
                                         <p>Supplier Name<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_Name" placeholder = "Enter Supplier Name" value ="<?php echo $rows['Supplier_Name'];?>" required>
                                         <p>Supplier Tel<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="supplier_Tel" placeholder = "Enter Supplier Tel" value ="<?php echo $rows['Supplier_Tel'];?>">
                                         <p>Supplier Email<p>
                                         <input type="email" class="form-control" style="border-radius: 10px;" name="supplier_Email" placeholder = "Enter Supplier Email" value ="<?php echo $rows['Supplier_Email'];?>">
                                         <p>Supplier Address<p>
                                         <textarea class="form-control" rows="3" name = "supplier_Address" placeholder = "Enter Supplier Address"><?php echo $rows['Supplier_Address'];?></textarea>                                                                       
                                     </div>
                                     <hr>
                                     <button type="submit" class="btn waves-effect waves-light btn-outline-success" name="editSupplier">Update Supplier</button>
