<?php
session_start();
require_once $_SERVER['DOCUMENT_ROOT'].'/php_posv3/PHP/stockin.php';
                    ...
                    <div class="card-body">
                         ...
                         <form method="POST">
                                     <div class="form-group">
                                         ...
                                         <p>Supplier<p>
                                         <select class="form-control" name = "supplier_ID" style="border-radius: 10px;" required>
                                         <?php while($row = mysqli_fetch_array($supplierRes)):;?>
                                     ...
                                     <hr>
                                     <button type="submit" class="btn waves-effect waves-light btn-outline-success" name="addStock">Add Stock</button>
