                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                href="authentication-register1.html" aria-expanded="false"><i data-feather="lock"
                                    class="feather-icon"></i><span class="hide-menu">Register User
                                </span></a>
                        </li>
               ...
               <div class="card">
                   <div class="card-body">
                        ...
                        <form>
                                    ...
                                    <hr>
                                    <input class="btn btn-block btn-xs btn-outline-success" type="submit" name="submit" value="Register User">
                                    <button type="reset" class="btn btn-block btn-xs btn-outline-danger">Reset</button>
