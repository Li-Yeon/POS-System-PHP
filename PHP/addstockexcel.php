...
$activeSheet -> setCellValue('D1', 'Supplier');
$activeSheet -> setCellValue('E1', 'Date In');
...
if(mysqli_num_rows($query) > 0)
{
    ...
    while ($row = mysqli_fetch_assoc($query))
    {
        ...
        $activeSheet -> setCellValue('D'.$no, $row['Supplier']);
        $activeSheet -> setCellValue('E'.$no, $row['Date_In']);
