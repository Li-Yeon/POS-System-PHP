<?php
session_start();
require_once $_SERVER['DOCUMENT_ROOT'].'/php_posv3/PHP/category.php';
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Update Category
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            ?>
                                     <div class="form-group">
                                         <p>No<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="no" placeholder = "<?php echo $rows['No'];?>" readonly>
                                         <p>Category<p>
                                         <input type="text" class="form-control" style="border-radius: 10px;" name="category" placeholder="Enter Category Name" value ="<?php echo $rows['Category'];?>" required>                       
                                     </div>
                                     <hr>
                                     <button type="submit" class="btn waves-effect waves-light btn-outline-success" name="editCategory">Update Category</button>
