    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Stock In
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <a href="addstockin.php"><button type="button" class="btn waves-effect waves-light btn-outline-success" style="margin-top:1%">+ Add Stocks</button></a>
                <a href="./PHP/addstockexcel.php"><button type="button" class="btn waves-effect waves-light btn-outline-success" style="margin-top:1%"><i class="far fa-file-excel" style="margin-right: 3px"></i>Print to Excel</button></a>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered">
                                        ...
                                        while($rows=mysqli_fetch_assoc($stockInTable))
                                    {
                                        ...
                                        <td><?php echo $rows['Date_In'];?></td>
                                        <td><?php echo $rows['Issued'];?></td>            
                                            <td class ="tableAction">
                                        <a href="addstocks.php?delete=<?php echo $rows['No'];?>" onclick="return confirm('Confirm delete stock?');"><button type="button" class="btn btn-outline-danger"><i class="far fa-trash-alt"></i></button></a>
                                            </td>
                            </tr>
                            <?php
                        }
