<?php
session_start();
require_once $_SERVER['DOCUMENT_ROOT'].'/php_posv3/PHP/dashboard.php';
                ...
                <div class="card-group">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo $totalPD?></h2>
                                    </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                            class="set-doller">RM</sup>0</h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Earnings
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Stocks</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium"><?php echo $totalCst?></h2>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-style-none mb-0">
                                    <li>
                                        ...
                                        <span class="text-dark float-right font-weight-medium">RM2346</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-danger font-10 mr-2"></i>
                                        <span class="text-muted">Referral Sales</span>
                                        <span class="text-dark float-right font-weight-medium">RM2108</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-cyan font-10 mr-2"></i>
                                        <span class="text-muted">Affiliate Sales</span>
                                        <span class="text-dark float-right font-weight-medium">RM1204</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Top Staff</h4>
                                    <div class="ml-auto">
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="font-weight-medium text-dark border-top-0 px-2 py-4">RM96K
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="px-2 py-4">
                                                ...
                                                <td class="font-weight-medium text-dark px-2 py-4">RM85K</td>
                                            </tr>
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                ...
                                                <td class="font-weight-medium text-dark px-2 py-4">RM81K</td>
                                            </tr>
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                ...
                                                <td class="font-weight-medium text-dark px-2 py-4">RM80K</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
