            ...
            <div class="container-fluid">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                            class="set-doller">RM</sup><?php echo $getSum?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo $totalSum?></h2>
                                    </div>
                ...
                <div class="row">                
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Top 5 Selling Products</h4>
                    ...
                    <div class="card">
                            <div class="card-body">
                            <h4 class="card-title mb-4">Recent Stock In</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                        <?php
                                        while($rows=mysqli_fetch_assoc($stockInTable))
                                    {
                                        ?>
                                        <tr>
                                        <td><?php echo $rows['Product_Name'];?></td>
                    ...
                    <div class="card">
                            <div class="card-body">
                            <h4 class="card-title mb-4">Top 5 Staff</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                        <?php
                                        while($rows=mysqli_fetch_assoc($staffTable))
                                    {
                                        ?>
                                        <tr>
                                        <td><?php echo $rows['Issued'];?></td>
                                        <td>RM<?php echo $rows['TotalSold'];?></td>
                                        </td>
                                        </tr>
                                    <?php
                                    }
